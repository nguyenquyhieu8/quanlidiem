            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form method="post" action="{{ route('quantri.user.update', $user->id) }}" class="form-horizontal">
                            @csrf
                            @method('PUT') 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control @error('is_active') is-invalid @enderror" name="is_active">
                                        <option value="1"
                                            {{ old('is_active', $user->is_active) == 1 ? 'selected' : '' }}>Kích hoạt
                                        </option>
                                        <option value="0"
                                            {{ old('is_active', $user->is_active) == 0 ? 'selected' : '' }}>Vô hiệu hóa
                                        </option>
                                    </select>
                                    @error('is_active')
                                        <p class="alert">{{ $message }}</p>
