            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content mb-2">
                        <a href="{{ route('quantri.years.create') }}">
                            <button type="button" class="btn btn-primary mb-3">Thêm năm học</button>
                        </a>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center list-action action">
                                                        <a class="badge badge-info mr-2" data-toggle="tooltip"
                                                            ...
                                                            href="{{ route('quantri.years.edit', $item->id) }}"><i
                                                                class="fa fa-pencil" aria-hidden="true"></i></a>
                                                        <a href="">
                                                            <form action="{{ route('quantri.years.destroy', $item->id) }}"
