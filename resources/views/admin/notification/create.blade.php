            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        ...
                        @endif
                        <form action="{{ route('quantri.noti.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="user_id" name="user_id" class="form-select">
                                        <option value="" selected>Không chọn người dùng</option>
                                        <!-- Cập nhật để cho phép không chọn -->
